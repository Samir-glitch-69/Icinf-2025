#GUIA RÁPIDA DE OPERADORES EN PYTHON (Hecha por el profesor)
...
#Operaciones Comunes (signos matematicos)
...
print("Hola" * 5)
#si multiplica o escribe el texto 5 veces


#¿y la siguiente multiplicación?
#print("Hola" * 3.5*2)
#Si el resultado es un 7 (numero entero), ¿por qué sale error?
#sale error por que cuando uno multiplica el float con el entero este se vuelve float 7.0 el cual no da para que python
#realize la multiplicacion por ser un float, tendria que definirse despues con un = para que sea un entero envez de float

#¿y esta operación un poco mas elaborada?
print("Hola" * (int((10 * 2) / 5)),"\n")
# si se logra por lo dicho anteriormente por que se define integer antes de la operacion print

#¿y por último esta operación de suma?
#print("Hola" + 20)
#no se peude concatenar ( combinar dos textos ) con un int se tendria que transformar el 20 a un str para que se combine
# en una sola linea de str
...
#aqui no depende de lo escrito depende de El código ASCII con sus valores especificos de cada simbolo o letra 
